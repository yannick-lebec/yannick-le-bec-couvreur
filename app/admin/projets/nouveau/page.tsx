...
export default function NouveauProjet() {
  ...
  const [form, setForm] = useState({
    titre: '', lieu: '', description: '', categorie: '', date: '',
  })
    ...
    <AdminLayout>
      <div className="max-w-2xl">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="font-bebas text-3xl text-noir tracking-widest">NOUVEAU PROJET</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 space-y-6">
          ...
          <div className="flex gap-4 pt-2">
            ...
            <button type="submit" disabled={saving}
              ...
              {saving ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />Sauvegarde...</> : 'Publier le projet'}
            </button>
          </div>
        </form>
      </div>
