...
const services = [
  ...
  {
    titre: 'Étanchéité',
    desc: 'Étanchéité de toitures terrasses, traitement des points singuliers, membranes bitumineuses.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    titre: 'Urgences',
    desc: 'Intervention rapide après tempête, dégât, infiltration. Bâchage et sécurisation immédiate.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
